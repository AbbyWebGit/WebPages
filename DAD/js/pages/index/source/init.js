...
define(function (require, exports, module) {
    ...
    var chartTheme =require('../../../module/ui/echarts3.theme.white');
    ...
    var _this = {
        ...
        initLine: function () {
            var _options = $.extend(true,_mockData.chartLine,chartTheme),
                _dom = echarts.init(document.getElementById('line-chart'));
            _dom.setOption(_options);
        },
        initPie: function () {
            var _options = $.extend(_mockData.chartPie,{}),
                _dom = echarts.init(document.getElementById('pie-chart'));
            _dom.setOption(_options);
        },
        initBar: function () {
            var _options = $.extend(_mockData.chartBar,{}),
                _dom = echarts.init(document.getElementById('bar-chart'));
            _dom.setOption(_options);
        },
        objs: {} //组件容器
    }
